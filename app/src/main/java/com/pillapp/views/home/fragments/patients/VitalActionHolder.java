...
public class VitalActionHolder extends RecyclerView.ViewHolder {
    View sideBar;
    TextView tvReminderDate, tvReminderDrug;
    Button btnPatient;
    private final RvReminderInterface rvReminderInterface;

    public VitalActionHolder(@NonNull View itemView, RvReminderInterface rvReminderInterface) {
        super(itemView);
        ...
        itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                VitalActionHolder.this.rvReminderInterface.onItemClickReminder(pos);
            }
        });
    }
}
