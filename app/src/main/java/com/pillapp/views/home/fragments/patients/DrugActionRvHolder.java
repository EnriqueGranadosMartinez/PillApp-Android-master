...
public class DrugActionRvHolder extends RecyclerView.ViewHolder{
    View sideBar;
    TextView tvReminderDate, tvReminderDrug;
    Button btnPatient;
    private final RvReminderInterface rvReminderInterface;

    public DrugActionRvHolder(@NonNull View itemView, RvReminderInterface rvReminderInterface) {
        super(itemView);
        ...
        itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DrugActionRvHolder.this.rvReminderInterface.onItemClickReminder(pos);
            }
        });
    }
}
