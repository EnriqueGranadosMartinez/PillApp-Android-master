...
public class MeetingRvHolder extends RecyclerView.ViewHolder {
    View sideBar;
    TextView tvReminderDate, tvReminderDrug;
    Button btnPatient;
    private final RvReminderInterface rvReminderInterface;

    public MeetingRvHolder(@NonNull View itemView, RvReminderInterface rvReminderInterface) {
        super(itemView);
        ...
        itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                MeetingRvHolder.this.rvReminderInterface.onItemClickReminder(pos);
            }
        });
    }
}
